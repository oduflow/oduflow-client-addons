...
Version `19.0.1.4.0` combines the platform and client modules. Upgrade `odumcp` in place; keep existing records, profiles, approvals and audit logs. The bundled `deploy/odumcp_server` remains available. The application is now labelled **MCP**.
