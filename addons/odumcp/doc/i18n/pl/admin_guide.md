...
Wersja `19.0.1.4.0` łączy moduły platformy i klienta. Zaktualizuj `odumcp` w miejscu; zachowaj istniejące rekordy, profile, zatwierdzenia i dzienniki audytu. Dołączony `deploy/odumcp_server` pozostaje dostępny. Aplikacja ma teraz nazwę **MCP**.
