...
from odumcp_server.auth import OdooApiKeyVerifier
...
@pytest.mark.parametrize(
    ...
    [
        ...
        {"ok": False},
        {"ok": True, "data": []},
        {"ok": True, "data": {"database": "prod", "user_id": "42", "profile": "sales"}},
    ],
)
async def test_verifier_rejects_invalid_identity_envelopes(payload: object) -> None:
    verifier = OdooApiKeyVerifier(
        _settings(identity_cache_seconds=0),
