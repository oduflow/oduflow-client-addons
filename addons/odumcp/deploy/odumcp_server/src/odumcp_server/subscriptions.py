...
class OdooEventBridge:
    ...
    async def ensure_watcher(self, access_token: AccessToken) -> None:
        ...
        task = asyncio.create_task(
            ...
            name=f"odumcp-events:{access_token.subject}",
        )
            ...
            try:
                ...
                response = await self._client.post(
                    ...
                    headers={
                        ...
                        "Content-Type": "application/vnd.odumcp+json",
                        "User-Agent": "odumcp-server/2.0",
                    },
                    json={"last": last},
    ...
    async def _handle_message(self, subject: str, message: str | bytes) -> None:
        ...
        for notification in notifications:
            ...
            if not isinstance(event, dict) or event.get("type") != "odumcp_resource_updated":
                continue
    ...
    def _events_url(self) -> str:
        ...
        return urlunparse((parsed.scheme, parsed.netloc, "/odumcp/v1/events", "", "", ""))
