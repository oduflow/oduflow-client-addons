...
class TestOduMcp(TransactionCase):
    ...
    def test_config_parameter_policy_enforces_prefix_and_read_only(self):
        self.profile.default_model_access = "write"
        self.mcp_user.group_ids = [Command.link(self.env.ref("base.group_system").id)]
    ...
    def test_approval_url_uses_configured_base_and_exact_plan(self):
        ...
        expected_url = f"https://odoo.example.test/odoo/action-{action.id}/{approval.id}"
