...
OduLogin lets an Odoo 18 settings administrator temporarily use the current
...
The implementation is an independent Odoo 18 module inspired by the behavior
