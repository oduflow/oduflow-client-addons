...
OduLogin lets an Odoo 16 settings administrator temporarily use the current
...
The implementation is an independent Odoo 16 module inspired by the behavior
