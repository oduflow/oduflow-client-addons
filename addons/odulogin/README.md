...
OduLogin lets an Odoo 19 settings administrator temporarily use the current
...
The implementation is an independent Odoo 19 module inspired by the behavior
