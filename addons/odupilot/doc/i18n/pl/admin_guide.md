<!-- i18n source=admin_guide.md sha=9af88a4ec835 lang=pl -->
# Podręcznik administratora OduPilot

## Instalacja na Odoo 16
...
Jest to port do instalacji na Odoo 16. Nie przenosi istniejącej bazy Odoo 15 ani nie zmienia nazw zainstalowanych rekordów bazy. Importowane wpisy zmian opisują historię modułu źródłowego.
