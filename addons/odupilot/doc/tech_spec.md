...
OduPilot is the Odoo 18 port of VelesAgro `ai_chat` 15.0.1.46.0. The addon and
...
license and Odooist attribution remain. This addon installs into a new Odoo 18
...
Dependencies are `mail`, `auth_totp` and the accompanying Odoo 18 `odumcp`.
...
part of an Odoo 18 `ir.module.category`; installation does not alter existing
...
Odoo 18 `_to_store` serializes custom channel and message properties.
