# Oduscale for Odoo 19

Oduscale manages employee VPN access to Odoo through Headscale and Tailscale.
It supports multiple companies and servers, single-use enrollment keys, device
inventory, access revocation and an audit history.

## Documentation

- [User guide](doc/user_guide.md): connect employees, inspect devices and revoke access.
